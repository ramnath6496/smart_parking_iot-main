        ...
        <div className="home">
            ...
            <section id="slots" className="slots container">
                ...
                <div className="parking container">
                    <div className='parking-boc-section'>
                        <div className="parking-name">Parking 1</div>
                        <div className="parking-value">Value</div>
                    </div>

                    <div className='parking-boc-section'>
                        <div className="parking-name">Parking 2</div>
                        <div className="parking-value car-parked">Value</div>
                    </div>
            ...
            <section id="testimonials" className="testimonials">
                ...
                <div className="testimonial">
                    <img src="https://freefrontend.com/assets/img/bootstrap-testimonials/bootstrap-4-testimonial-card-section.png" alt="" />
                </div>
            ...
            <section id="contact-us" className="contact-us">
                ...
                <form action="" className="contact">
                    <div className="fields">
                        ...
                        <input type="text" id='first' placeholder='Enter your first name' name='first' />
                    </div>
                    <div className="fields">
                    ...
                    <div className="fields">
                        ...
                        <textarea name="message" id="message" placeholder='Enter the mesage.' rows="5"></textarea>
                    </div>
